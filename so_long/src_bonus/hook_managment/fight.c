...
/*   Updated: 2025/01/17 05:52:29 by cw3l             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_fight_right(t_data *data, t_xy m)
{
	while (ft_fight_checker(data) && data->life > 0)
	{
		...
		if (data->life == 0)
			frame_layer(data, data->img_set_global[17],
				data->xy_data.begin, 8);
		mlx_loop(data->mlx);
	}
}

void	ft_fight_left(t_data *data, t_xy m)
{
	while (ft_fight_checker(data) && data->life > 0)
	{
